        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    id_usuario_dados = table.Column<int>(type: "integer", nullable: true),
                    ...
                    id_sexo = table.Column<int>(type: "integer", nullable: false),
                    criado = table.Column<int>(type: "integer", nullable: false),
                    atualizacao = table.Column<int>(type: "integer", nullable: false),
                    data_vencimento_plano = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    data_expiracao_senha = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ...
                    termo_uso_em = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ...
                    normalized_login = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    ...
                    celular_confirmado = table.Column<bool>(type: "boolean", nullable: false),
