    ...
    public static class IdentityExtension
    {
        ...
        public static string Regra(this IIdentity identity)
        {
            ...
            try
            {
                ...
                string strRegra = claim.Value.Replace("Publicitario", "Publicit�rio");
                retorno = strRegra.Replace("Usuario", "Usu�rio");
            }
            catch (Exception ex)
            {
        ...
        public static string Role(this IIdentity identity)
        {
            string retorno;
            try
            {//Devolve a regra para uso em c�digo
                ClaimsIdentity claimsIdentity = identity as ClaimsIdentity;
                Claim claim = claimsIdentity.FindFirst(ClaimTypes.Role);
                retorno = claim.Value;
            }
        ...
        public static int idUsuarioDados(this IIdentity identity)
        {
            int retorno;
            try
            {
                ClaimsIdentity claimsIdentity = identity as ClaimsIdentity;
                Claim claim = claimsIdentity.FindFirst(type: "idUsuarioDados");
                retorno = Convert.ToInt32(claim.Value);
            }
            catch (Exception ex)
            {
                LogErro(classe, "idUsuarioDados", ex.Message, identity.Id());
                retorno = 0; //Sem id de dados
            }
            return retorno;
        }
